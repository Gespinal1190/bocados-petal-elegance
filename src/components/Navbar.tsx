...
const Navbar = () => {
  ...
  return (
    ...
    >
      <div className={`mx-auto max-w-5xl border transition-all duration-500 ${scrolled ? "border-border bg-background/95 shadow-soft backdrop-blur-md" : "border-primary-foreground/25 bg-primary/80 backdrop-blur-md"}`}>
          ...
          <div className="hidden items-center gap-3 md:flex">
            <a
              ...
              className={`transition-colors ${
                scrolled ? "text-foreground/60 hover:text-primary" : "text-primary-foreground/70 hover:text-primary-foreground"
              }`}
            >
            ...
            <a
              href="#reservas"
              className={`ml-1 border px-5 py-2 text-[10px] font-medium uppercase tracking-[0.14em] transition-all duration-300 ${
                scrolled
        ...
        {isOpen && (
          <div className="border-t border-border bg-background md:hidden animate-fade-in">
            <div className="flex flex-col py-6 px-4 space-y-1">
              ...
              <div className="pt-4 border-t border-border mt-4 flex items-center justify-center gap-6">
                <a
                  href="https://www.instagram.com/bocadosrestobar/"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <a
                  href="tel:+34931427406"
                  className="text-foreground/60 hover:text-primary transition-colors flex items-center gap-2 text-xs tracking-wider"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-foreground/60 transition-colors hover:text-whatsapp"
                >
